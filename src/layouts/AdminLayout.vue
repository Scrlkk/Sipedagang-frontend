...
<template>  <div class="min-h-screen w-full relative overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50">
    <!-- Top SVG Wave -->
    ...
    <div class="absolute bottom-0 left-0 z-0 w-1/2 sm:w-1/3 md:w-auto">
      ...
      >
        ...
        />
        <defs>
          <linearGradient id="gradient-bottom-left" x1="0%" y1="0%" x2="100%" y2="0%">
    ...
    <div class="absolute bottom-0 right-0 z-0 w-2/3 md:w-auto">
      ...
      >
        ...
        />
        <defs>
          <linearGradient id="gradient-bottom-right" x1="0%" y1="0%" x2="100%" y2="0%">
    ...
    >
      <div class="flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 md:px-8 lg:px-10 py-4 sm:py-5 lg:py-6">        <!-- Logo -->
        ...
        <div class="flex items-center gap-3 sm:gap-4 lg:gap-5">
          ...
          >
            <div class="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 rounded-full overflow-hidden flex-shrink-0 ring-1 ring-white/30">
              <img
                :src="profilePhoto"
                :alt="userName"
          ...
          >            <div
            ...
            >
              ...
              <button
                @click="handleLogout"
                class="flex items-center w-full px-4 py-3 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 transition-all duration-200 gap-3 group"
              >
                <div class="w-5 h-5 flex items-center justify-center bg-gray-100 group-hover:bg-red-100 rounded-lg transition-colors duration-200">
                  <svg
                    width="14"
                    height="14"
                    viewBox="0 0 20 21"
    ...
    <main class="px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 relative z-[1] pb-20 sm:pb-24 md:pb-28 pt-2 sm:pt-4">
      <slot></slot>
    </main>
  </div>
</template>
