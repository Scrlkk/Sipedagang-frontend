<template>
  <div class="relative w-screen h-screen overflow-hidden">
    <!-- SVG Backgrounds -->
    <svg
      class="absolute top-0 left-0 w-full md:w-[1000px] h-[10vw] min-h-[60px] max-h-[198px] z-0"
    ...
    <svg
      class="absolute bottom-0 left-0 w-full h-[18vw] min-h-[100px] max-h-[250px] z-0"
      viewBox="0 0 1919 298"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      preserveAspectRatio="none"
    >
    ...
    <!-- Content Layer -->
    <div
      class="absolute inset-0 z-20 w-full h-full flex flex-col items-center justify-center px-4"
    >
      <slot />
    </div>
  </div>
