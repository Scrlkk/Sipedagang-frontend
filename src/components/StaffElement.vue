...
<template>
  <div
    @click="goToStaff"
    class="cursor-pointer flex bg-[#F7F8FA] py-5 px-7 rounded-lg shadow-lg/25 flex-grow basis-[300px] max-w-[400px] h-[6.2rem] hover:scale-95 hover:bg-[#E4E7EC] transition-all duration-200 ease-in-out"
  >
    <div class="w-full flex items-center gap-4">
      ...
      <div class="flex flex-col justify-center">
        <div class="font-bold md:text-xl sm:text-sm">{{ person.nama }}</div>
        <p class="text-sm">{{ person.tempat }}</p>
      </div>
    </div>
    <div class="flex items-end -mr-1 -mb-1">
      <!-- SVG ICON -->
      <svg
        width="26"
        height="25"
