...
const handleSubmit = async () => {
  ...
  try {
    ...
    setTimeout(() => {
      ...
      }, 2000) // Give user time to see success message before redirecting
    }, 1000)
  } catch (error) {
      ...
      <div class="bg-white rounded-lg w-full max-w-md shadow-lg p-8">
        ...
        <div class="text-center mb-6">
          ...
          <div class="text-gray-600 mt-2 text-sm">
            Masukkan password baru untuk permintaan reset password
          </div>
        </div>
        ...
        <form v-if="!requestSent" @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            <button 
              ...
              :disabled="isLoading"
            >
              <span v-if="isLoading">Mengirim Permintaan...</span>
              <span v-else">Kirim Permintaan Reset Password</span>
            </button>
          </div>
        ...
        <div v-else class="space-y-6 text-center">
          <div class="p-4 bg-blue-50 text-blue-700 rounded-md">
            ...
            <p class="text-sm">
              Permintaan reset password Anda telah dikirim ke SuperAdmin untuk diverifikasi. 
              Silakan tunggu persetujuan dari SuperAdmin.
            </p>
            <div class="mt-3 text-xs bg-blue-100 p-2 rounded">
              Status: <span class="text-orange-600 font-medium">Menunggu Persetujuan</span>
            </div>
          </div>
        </div>
