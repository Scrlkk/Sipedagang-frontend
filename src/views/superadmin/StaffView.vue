...
<template>
  <SuperAdminLayout>
    <section class="relative">      <MainElement
        :class="showPopup ? 'blur-[3px] pointer-events-none select-none' : ''"
      >
        <div class="flex flex-col h-full">          <!-- ATAS -->
          <section class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-3 mb-3 flex-shrink-0">
          <!-- TITLE -->
          <div
        ...
        >
          ...
          >
            ...
            <div v-else class="text-gray-500 text-sm sm:text-base font-medium text-center px-4">
              {{
                showInactive
