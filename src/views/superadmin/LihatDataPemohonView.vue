      ...
      >
        <div>
          ...
          <div class="mt-3 space-y-2 bottom-0 py-12 sm:py-5 lg:py-0 xl:py-2">
            ...
            <!-- ✅ Info data count yang lebih compact -->
            <div
              v-if="data.length > 0"
            ...
            >
              <span>
                ...
                dari {{ pemohonStore.pagination.total }} data
              </span>
              <span v-if="searchText" class="text-blue-600 ml-1">
                untuk pencarian "<strong>{{ searchText }}</strong
                >"
              </span>
            </div>
          </div>
