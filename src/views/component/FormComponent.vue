...
<template>
  <div class="w-full max-w-5xl mx-auto px-2 sm:px-4">
    <div class="bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col h-auto max-h-[82vh] sm:max-h-[80vh] border border-gray-100 form-card">
      <!-- Form Header -->
      <div class="text-center pb-2 bg-white z-10 flex-shrink-0">
        <h1 class="text-lg sm:text-xl font-medium mt-4 sm:mt-6 mb-1 form-title" style="color: #0099FF;">Form Input Data</h1>
        <div class="mx-auto form-divider" style="height: 3px; background-color: #0099FF; width: 100%; max-width: 200px; margin-bottom: 16px;"></div>
      </div>
      
      <!-- Scrollable Form Content -->
      <div class="overflow-y-auto flex-grow min-h-0" role="main" aria-label="Form input data permohonan">
        <div class="p-3 sm:p-6 pb-2 sm:pb-6">
          <!-- Data Pemohon Section -->
          <fieldset class="mb-4 sm:mb-6 form-section">
            <legend class="font-medium text-base sm:text-lg mb-4 text-gray-900">Data Pemohon</legend>
            
            <div class="space-y-3">
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="namaSupplier" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                  Nama Supplier <span class="text-red-500" aria-label="wajib diisi">*</span>
                </label>
                <input
                  id="namaSupplier"
                  type="text"
                ...
                />
                <div id="namaSupplier-help" class="sr-only">Masukkan nama supplier yang mengajukan permohonan</div>
              </div>
              
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="namaPerusahaan" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                ...
                />
                <div id="namaPerusahaan-help" class="sr-only">Masukkan nama perusahaan supplier</div>
              </div>
              
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="jenisBank" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                  Jenis Bank
                </label>
                <div class="relative w-full sm:w-3/4">
                  ...
                  <div class="absolute right-3 top-3 text-gray-400 pointer-events-none" aria-hidden="true">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                  </div>
                </div>
                <div id="jenisBank-help" class="sr-only">Pilih jenis bank untuk rekening supplier</div>
              </div>
              
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="nomerRekening" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                  Nomer Rekening <span class="text-red-500" aria-label="wajib diisi">*</span>
                </label>
                <input
                  id="nomerRekening"
                  type="text"
                ...
                />
                <div id="nomerRekening-help" class="sr-only">Masukkan nomor rekening bank supplier</div>
              </div>
            </div>
          </fieldset>
          ...
          <fieldset class="mb-4 sm:mb-6 form-section">
            <legend class="font-medium text-base sm:text-lg mb-4 text-gray-900">Detail Purchasing Order</legend>
            
            <div class="space-y-3">
              <!-- PO Number -->
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="nomerPO" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                  Nomer PO <span class="text-red-500" aria-label="wajib diisi">*</span>
                </label>
                <input
                  id="nomerPO"
                  type="text"
                ...
                />
                <div id="nomerPO-help" class="sr-only">Masukkan nomor Purchase Order sesuai format yang ditentukan</div>
              </div>
              
              <!-- Date -->
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="tanggalPengadaan" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                  Tanggal Pengadaan <span class="text-red-500" aria-label="wajib diisi">*</span>
                </label>
                <input
                  id="tanggalPengadaan"
                  type="date"
                ...
                />
                <div id="tanggalPengadaan-help" class="sr-only">Pilih tanggal pengadaan barang</div>
              </div>
              
              <!-- Jenis Pengadaan -->
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="jenisPengadaan" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                  Jenis Pengadaan
                </label>
                <div class="relative w-full sm:w-3/4">
                  <select
                ...
                <div id="jenisPengadaan-help" class="sr-only">Pilih jenis barang yang akan diadakan</div>
              </div>
              
              <!-- Kuantum -->
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="kuantum" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                  Kuantum <span class="text-red-500" aria-label="wajib diisi">*</span>
                </label>
                ...
                <div id="kuantum-help" class="sr-only">Masukkan jumlah kuantum barang yang akan diadakan</div>
              </div>
            </div>
          </fieldset>

          <!-- Data IN Section -->
          <fieldset class="mb-4 sm:mb-6 mt-6 p-3 sm:p-4 rounded-lg form-section">
            <legend class="font-medium text-base sm:text-lg mb-4 text-gray-900">Data IN</legend>
            
            <!-- Dynamic rows -->
            <div class="space-y-3" role="group" aria-label="Daftar data IN">
              <div v-for="(item, index) in dataIN" :key="index" class="flex items-center space-x-2 p-2 rounded">
                <div class="flex-none w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-md flex items-center justify-center">
                  <span class="text-xs sm:text-sm font-medium">{{ index + 1 }}</span>
                </div>
                <div class="flex-none w-32 sm:w-44 lg:w-56">
                  <label :for="`tanggal-${index}`" class="sr-only">Tanggal untuk baris {{ index + 1 }}</label>
                  <input
                    :id="`tanggal-${index}`"
                    type="date"
                    :value="item.tanggal"
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex">
                    <label :for="`kuantum-${index}`" class="sr-only">Kuantum untuk baris {{ index + 1 }}</label>
                    <input
                      :id="`kuantum-${index}`"
                      type="text"
                      :value="item.kuantum"
            ...
            <div class="flex justify-center mt-4">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-1" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <fieldset class="mb-4 sm:mb-6 form-section">
            <legend class="font-medium text-base sm:text-lg mb-4 text-gray-900">Informasi Pembayaran</legend>
            
            <div class="space-y-3">
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="jumlahPembayaran" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                  Jumlah Pembayaran
                </label>
                <input
                  id="jumlahPembayaran"
                ...
                />
                <div id="jumlahPembayaran-help" class="sr-only">Masukkan jumlah pembayaran dalam rupiah</div>
              </div>
              
              <div class="flex flex-col sm:flex-row sm:items-center">
                <label for="jumlahSPP" class="block text-gray-700 sm:w-1/4 mb-1 sm:mb-0 text-sm sm:text-base font-medium">
                  Jumlah di-SPP
                </label>
                <input
                  id="jumlahSPP"
                ...
                />
                <div id="jumlahSPP-help" class="sr-only">Masukkan jumlah dalam SPP (Surat Permintaan Pembayaran)</div>
              </div>
            </div>
          </fieldset>
        </div>
      ...
      <div class="flex-shrink-0 px-3 sm:px-6 py-3 sm:py-4 bg-white border-t border-gray-100 z-10 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-4">
        <button 
