  ...
  <div class="px-4 max-w-7xl mx-auto -mt-4">
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
      ...
      <div class="bg-blue-600 p-2 sm:p-4">
        ...
        <div class="hidden sm:flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3">
          <!-- Title -->
      ...
      <div class="p-3 sm:p-6">
        <!-- Table Container -->
        <div class="relative text-xs sm:text-sm overflow-hidden rounded-lg shadow-sm border border-gray-200">
          <!-- Mobile Card View -->
