...
<div class="flex flex-col items-center">
    ...
    <div class="flex justify-center flex-col">
      ...
      <div class="w-full max-w-[210mm] min-h-[297mm] p-10 px-12 mx-auto font-arial leading-normal text-black relative print:shadow-none page">        <!-- Header dengan format seperti di gambar -->
        ...
        <div class="mb-1">
          <p class="m-0">Dengan ini kami mengajukan permohonan pembayaran pengadaan {{ formData.jenisPengadaan }} sesuai IN :</p>
        </div>
        
        <!-- Data entries without dotted lines and numbering -->
        <template v-if="formData.dataIN && formData.dataIN.length > 0">
          <div v-for="(item, index) in formData.dataIN" :key="index" class="mb-1">
            <div class="flex">
